          ...
          <el-tab-pane label="基本信息" name="first">
            <el-form :model="userlist" :rules="rules" ref="EditorUserForms">
                ...
                <el-form-item label="身份证" prop="idcard" :label-width="formLabelWidth">
                  <el-col :span="8">   <el-input v-model="userlist.idcard" placeholder="请输入身份证号码"></el-input></el-col>
                </el-form-item>
...
/*****检验两次密码是否一致***/
  ...
  methods: {
    ...
    getUser() {
      ...
      console.log(id);
      var URL="http://10.89.127.171:1337/api-platform/v1/user?id="+this.id;
      axios.get(URL).then(response => {
        if (response.data.code === 201) {
          this.userlist.email = response.data.data.email;
          this.loading = false;
